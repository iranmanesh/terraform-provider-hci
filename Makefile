# Project variables
ORG         := hypertec-cloud
NAME        := terraform-provider-hci
DESCRIPTION := Terraform provider to interact with hypertec.cloud infrastructure
AUTHOR      := hypertec.cloud
URL         := https://github.com/hypertec-cloud/terraform-provider-hci
LICENSE     := MIT
